...
X,y = make_circles(n_samples=10000,factor=0.5,noise=0.20,random_state=42)
...
bagging_model = BaggingClassifier(estimator=DecisionTreeClassifier(random_state=42),bootstrap=False,verbose=True,max_samples=0.08,n_estimators=50,oob_score=False,random_state=42)
