...
plt.yticks(range(len(importances)),['MinTemp','MaxTemp','Rainfall'])
plt.show()

viz = dtreeviz.model(model=tree_model,X_train=x_train,y_train=y_train,target_name='RainTomorrow',feature_names=['MinTemp','MaxTemp','Rainfall'],class_names={0:'No',1:'Yes'})
viz.view()
